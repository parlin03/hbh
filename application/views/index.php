...
<head>
  ...
  <!-- Page Title -->
  <title>HBH IKATEK UH 2024</title>

  <!-- Compressed Styles -->
  <link href="<?= base_url('assets/home/') ?>css/slides.min.css" rel="stylesheet" type="text/css">
  ...
  <!-- Compressed Scripts -->
  <script src="<?= base_url('assets/home/') ?>js/slides.min.js" type="text/javascript"></script>
...
<body class="slides horizontal simplifiedMobile animated">
  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display:none">
    ...
    <symbol id="logo-icon" viewBox="0 0 50 41">
      <title>HBH IKATEK UNHAS 2024</title>
  ...
  <nav class="panel top">
    <div class="sections desktop">
      <div class="left"><a href="#" title="Slides Framework">HBH IKATEK UH 2024</a></div>
      <div class="center">
        <ul class="menu">
          <li><a href="#expo">IKATEK HYBRID EXPO</a></li>
          <li><a href="#funrun">TEKNIK FUN RUN 5K</a></li>
          ...
          <div class="fix-12-12">
            <ul class="flex fixedSpaces verticalCenter reverse">
              <li class="col-6-12 left middle">
                ...
                <!-- <a href="<?= base_url('registration') ?>" disabled class="button blue gradient ae-3 fromCenter">Registration</a> -->
                <a href="https://www.instagram.com/hbhikatekunhas/" class="button white ae-4 fromCenter">Learn more</a>
              </li>
              <li class="col-6-12">
                <img class="ae-4" width="200" src="assets/home/img/logo.png" alt="HBH Thumbnail" data-action="zoom" />
              </li>
            </ul>
          </div>
  ...
  <!-- Slide 2 (#60) -->
  <section class="slide fade-6 kenBurns" id="expo">
    <div class="content">
      <div class="container">
        <div class="wrap">
          ...
          <div class="fix-12-12">
            <ul class="grid">
              <li class="col-6-12 left">
                <h1 class="ae-2 fromLeft">IKATEK HYBRID EXPO</h1>
                <div class="ae-3 fromRight">
                  <p class="opacity-8">Kampus Teknik Gowa</p>
                </div>
                <div class="relative">
    ...
    <div class="background" style="background-image:url(assets/home/img/background/expo.jpg)"></div>
  </section>
  ...
  <!-- Slide 3 (#27) -->
  <section class="slide fade-6 kenBurns" id="funrun">
    <div class="content">
      <div class="container">
        <div class="wrap">
          ...
          <div class="fix-12-12">
            <ul class="flex verticalCenter">
              ...
              <li class="col-7-12 left">
                <h1 class="ae-2 fromRight">TEKNIK FUN RUN 5K</h1>
                <div class="ae-3 fromRight">
                  <p class="opacity-8">Plazgozz Pettarani (start-finish)</p>
                </div>
                <div class="relative">
                  <img src="assets/home/img/datetime.png" class="ae-3 fromCenter app-26" alt="app" />
                  <div class="text-26">
    ...
    <div class="background" style="background-image:url(assets/home/img/background/funrun.jpg)"></div>
  </section>

  <!-- Slide 4 (#26) -->
  <section class="slide fade-6 kenBurns" id="hzh">
    <div class="content">
      <div class="container">
        <div class="wrap">
    ...
    <div class="background" style="background-image:url(assets/home/img/background/minisoccer.jpg)"></div>
  </section>

  <!-- Slide 5 (#91) -->
  <section class="slide fade-6 kenBurns" id="domino">
    <div class="content">
      <div class="container">
        <div class="wrap">

          <div class="fix-12-12 to left">
            <ul class="flex reverse verticalCenter">
              <li class="col-8-12 cell-27">
                <div class="fix-4-12">
    ...
    <div class="background" style="background-image:url(assets/home/img/background/domino-effect.jpg)"></div>
  </section>

  <!-- Slide 6 (#83) -->
  <section class="slide fade-6 kenBurns" id="malam-puncak">
    <div class="content">
      <div class="container">
        <div class="wrap">
          ...
          <div class="fix-12-12 toCenter">
            <div class="fix-7-12">
              <h1 class="ae-2 huge fromAbove margin-bottom-2">MALAM PUNCAK ACARA</h1>
            </div>
    ...
    <div class="background" style="background-image:url(assets/home/img/background/malam.jpg)"></div>
  </section>
